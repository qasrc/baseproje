...
public class ShiroDbRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(
        ...
        List<String> roleNameList = roleService.findRoleNameListByUserId(user.getId());
        ShiroUser shiroUser = new ShiroUser(user.getId(), user.getCode(), user.getName(), roleList, roleNameList);
        // 认证缓存信息
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(
        ...
        for (Long roleId : roleList) {
            roleSet.add(roleService.findRoleById(roleId).getName());
        }
