...
public class UserController extends BaseController {
    ...
    public Result add(UserVo userVo) {
        ...
        User u = userService.findUserByLoginName(userVo.getName());
        if (u != null) {
    ...
    public Result edit(UserVo userVo) {
        Result result = new Result();
        User user = userService.findUserByLoginName(userVo.getName());
        ...
        try {
            ...
            if (userVo.getPassword() != null && !userVo.getPassword().equals("") && !userVo.getPassword().matches("\\s+")) {
                userVo.setPassword(DigestUtils.md5Hex(userVo.getPassword()));
            } else {
                userVo.setPassword(null);
            }
