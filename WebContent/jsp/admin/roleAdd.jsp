...
<script type="text/javascript">
    ...
    var myloader = function(param, success, error) {
		...
		/* 	success : function(data) {
				console.log("i am in success-->" + data.obj);//返回的是数组对象data	
				var items = $.map(data.obj, function(item) {
					return {
						id : item.id,
						name : item.name
					};
			...
			success: function (data) {
				console.log("i am in success-->" + data.obj);
				var obj= $.parseJSON(data);

	             var items = $.each(data.obj, function(item) {
	...
	<div data-options="region:'center',border:false" title=""
		...
		<form id="roleAddForm" method="post">
			<table class="grid">
                ...
                <%--<tr>
                    <td>测试</td>
                    <td colspan="3"><input class="easyui-combobox" id="ceshi"
                        style="width: 250px"
