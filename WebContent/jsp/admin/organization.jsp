        ...
        treeGrid = $('#treeGrid').treegrid({
            ...
            columns : [ [ {
                ...
                formatter : function(value, row, index) {
                    ...
                    <shiro:hasAnyRoles name="乡村">
                            str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
                    str += $.formatString('<a href="javascript:void(0)" class="organization-easyui-linkbutton-del" data-options="plain:true,iconCls:\'icon-cancel\'" onclick="deleteFun(\'{0}\');" >删除</a>', row.id);
                    </shiro:hasAnyRoles>
                    return str;
                }
            } ] ],
            onLoadSuccess:function(data){
                ...
                $('.organization-easyui-linkbutton-del').linkbutton({text: '删除', plain: true, iconCls: 'icon-cancel'});
            },
            toolbar : '#toolbar'
        });
    });
