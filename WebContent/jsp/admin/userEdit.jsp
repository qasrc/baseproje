            ...
            <table class="grid">
                <tr>
                    ...
                    <td><input name="id" type="hidden"  value="${user.id}">
                        <input name="code" type="text" placeholder="请输入登录名称" class="easyui-textbox"
                               data-options="required:true" value="${user.code}"></td>
                    <td>姓名</td>
                ...
                <tr>
                    ...
                    <td>用户状态</td>
                    <td><select id="state" name="status" value="${user.status}" class="easyui-combobox"
                ...
                <tr>
                    ...
                    <td><select id="organizationId" name="organizationId" style="width: 140px; height: 29px;"
                                class="easyui-textbox" data-options="required:true"></select></td>
                    <td>角色</td>
                ...
                <tr>
                    ...
                    <td>user_id</td>
                    <td>
                        <input type="text" name="user_id" class="easyui-textbox" value="${user.user_id}"/>
                    </td>
                </tr>
            </table>
        </form>
