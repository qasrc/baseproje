    ...
    $(function() {
        ...
        dataGrid = $('#dataGrid').datagrid({
            ...
            },
            {
                ...
                formatter : function(value, row, index) {
                    ...
                    <%--<shiro:hasPermission name="/user/delete">--%>
                            str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
                    str += $.formatString('<a href="javascript:void(0)" class="user-easyui-linkbutton-del" data-options="plain:true,iconCls:\'icon-cancel\'" onclick="deleteFun(\'{0}\');" >删除</a>', row.id);
                    <%--</shiro:hasPermission>--%>
                    return str;
                }
            }] ],
            onLoadSuccess:function(data){
                ...
                $('.user-easyui-linkbutton-del').linkbutton({text: '删除', plain: true, iconCls: 'icon-cancel'});
            },
            toolbar : '#toolbar'
        });
    });
